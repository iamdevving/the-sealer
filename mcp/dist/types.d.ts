...
export type ClaimType = 'x402_payment_reliability' | 'defi_trading_performance' | 'code_software_delivery' | 'website_app_delivery' | 'acp_job_delivery';
export declare const CLAIM_LABELS: Record<string, string>;
export declare const VALID_CLAIM_TYPES: ClaimType[];
export {};
