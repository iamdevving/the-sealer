...
const CLAIM_TYPES = [
  ...
  { value: 'prediction_market_accuracy', label: 'Prediction Markets' },
];
      ...
      <div className="wrap">
        ...
        <div className="board">
          ...
          {loading ? (
            ...
            entries.map(e => (
              <div key={e.wallet} className="board-row" style={{cursor:'pointer'}} onClick={() => window.location.href=`/agent/${e.handle || e.wallet}`}>
