Updated with Changelog after moving to local
...
- **2026-02-27 v1.8** – Self-hosted x402 facilitator live on Base Sepolia (no Coinbase CDP dependency). Paywall is now 100% sovereign. New attestation TX 0x46f65a84... confirmed. Ready for Solana + ERC-8004 agent check.
- **2026-02-23/26 v1.7** - Moved to local, applied permanent links, released SEALed product.
